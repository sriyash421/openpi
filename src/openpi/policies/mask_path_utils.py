...
from vila_utils.utils.decode import add_path_2d_to_img_alt_fast
...
def preprocess_image(image, crop_type):
    ...
    image = cv2.resize(image, (DOWNSAMPLE_RESOLUTION, DOWNSAMPLE_RESOLUTION))
    return image
