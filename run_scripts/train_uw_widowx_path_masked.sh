...
EXP_NAME=pi0_lora_uw_widowx_expert_data_path_masked
PROJ_NAME=openpi
...
BASE_TRAIN_CMD="uv run scripts/train.py pi0_lora_uw_widowx_expert_data_path_masked --project_name=$PROJ_NAME --exp-name=$EXP_NAME"
