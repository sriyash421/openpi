...
#EXP_NAME=pi0_fast_bridge_full_fine_tuning_2_cam_random_bs8
EXP_NAME=pi0_fast_lora_bridge_2_cam_random
PROJ_NAME=hand-demos-openpi-training
# --- End Environment Setup ---

# --- Training Command Setup ---
# Define the base training command as a variable
#BASE_TRAIN_CMD="uv run scripts/train.py pi0_fast_bridge_full_fine_tuning_2_cam_random --project_name=$PROJ_NAME --exp-name=$EXP_NAME"
BASE_TRAIN_CMD="uv run scripts/train.py pi0_fast_lora_bridge_2_cam_random --project_name=$PROJ_NAME --exp-name=$EXP_NAME"
