...
EXP_NAME=pi0_fast_usc_widowx_play_bs16
PROJ_NAME=hand-demos-openpi-training
# --- End Environment Setup ---

# --- Training Command Setup ---
# Define the base training command as a variable
BASE_TRAIN_CMD="uv run scripts/train.py pi0_fast_usc_widowx_combined_play_data --project_name=$PROJ_NAME --exp-name=$EXP_NAME"
