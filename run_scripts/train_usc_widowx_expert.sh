...
EXP_NAME=pi0_fast_lora_usc_widowx_expert_data_bs148_5_19_data
PROJ_NAME=hand-demos-openpi-training
# --- End Environment Setup ---

# --- Training Command Setup ---
# Define the base training command as a variable
BASE_TRAIN_CMD="uv run scripts/train.py pi0_fast_lora_usc_widowx_expert_data --project_name=$PROJ_NAME --exp-name=$EXP_NAME"
