...
EXP_NAME=pi0_libero_90_fullpath_path_masked_bs148_rdp
...
BASE_TRAIN_CMD="uv run scripts/train.py pi0_libero_low_mem_finetune_fullpath_path_masked --exp-name=$EXP_NAME"
