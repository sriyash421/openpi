...
#EXP_NAME=pi0_libero_low_mem_finetune_path_new
#EXP_NAME=pi0_libero_low_mem_finetune_path_new_maxep5
EXP_NAME=pi0_libero_low_mem_finetune_path_new_90
...
BASE_TRAIN_CMD="uv run scripts/train.py pi0_libero_low_mem_finetune_path_90 --exp-name=$EXP_NAME"
